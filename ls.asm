...
ls(char *path)
{
 ...
 128:	a0c50513          	addi	a0,a0,-1524 # b30 <dump_test4_asm+0x6e>
 ...
 166:	99e58593          	addi	a1,a1,-1634 # b00 <dump_test4_asm+0x3e>
 16a:	4509                	li	a0,2
 ...
 17c:	9a058593          	addi	a1,a1,-1632 # b18 <dump_test4_asm+0x56>
 180:	4509                	li	a0,2
 ...
 1ae:	99650513          	addi	a0,a0,-1642 # b40 <dump_test4_asm+0x7e>
 ...
 1f2:	96aa0a13          	addi	s4,s4,-1686 # b58 <dump_test4_asm+0x96>
        printf("ls: cannot stat %s\n", buf);
 1f6:	00001a97          	auipc	s5,0x1
 1fa:	922a8a93          	addi	s5,s5,-1758 # b18 <dump_test4_asm+0x56>
...
main(int argc, char *argv[])
{
 ...
 2bc:	8b050513          	addi	a0,a0,-1872 # b68 <dump_test4_asm+0xa6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 648:	58c50513          	addi	a0,a0,1420 # bd0 <digits>
 64c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 74c:	43070713          	addi	a4,a4,1072 # b78 <dump_test4_asm+0xb6>
 ...
 7d6:	3feb8b93          	addi	s7,s7,1022 # bd0 <digits>
 ...
 82a:	34a90913          	addi	s2,s2,842 # b70 <dump_test4_asm+0xae>
        while(*s != 0){
...
0000000000000a66 <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000000a82 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 a84:	59d1                	li	s3,-12
  li s4, 123
 a86:	07b00a13          	li	s4,123
  li s5, -1234
 a8a:	b2e00a93          	li	s5,-1234
  li s6, 12345
 a8e:	6b0d                	lui	s6,0x3
 a90:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2019>
  li s7, -123456
 a94:	7b89                	lui	s7,0xfffe2
 a96:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0da0>
  li s8, 1234567
 a9a:	0012dc37          	lui	s8,0x12d
 a9e:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c667>
  li s9, -12345678
 aa2:	ff43acb7          	lui	s9,0xff43a
 aa6:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438e92>
  li s10, 123456789
 aaa:	075bdd37          	lui	s10,0x75bd
 aae:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbcf5>
  li s11, -1234567890
 ab2:	b66a0db7          	lui	s11,0xb66a0
 ab6:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed0e>
#ifdef SYS_dump
  li a7, SYS_dump
 aba:	48d9                	li	a7,22
  ecall
...
0000000000000ac2 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 ac2:	80000937          	lui	s2,0x80000
 ac6:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefdf>
  li s3, -2147483648
 ac8:	800009b7          	lui	s3,0x80000
  li s4, 1337
 acc:	53900a13          	li	s4,1337
  li s5, 2020
 ad0:	7e400a93          	li	s5,2020
  li s6, 3234
 ad4:	6b05                	lui	s6,0x1
 ad6:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0xd2>
  li s7, 3235
 ada:	6b85                	lui	s7,0x1
 adc:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0xd3>
  li s8, 3236
 ae0:	6c05                	lui	s8,0x1
 ae2:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0xd4>
  li s9, 3237
 ae6:	6c85                	lui	s9,0x1
 ae8:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0xd5>
  li s10, 3238
 aec:	6d05                	lui	s10,0x1
 aee:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0xd6>
  li s11, 3239
 af2:	6d85                	lui	s11,0x1
 af4:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0xd7>
#ifdef SYS_dump
  li a7, SYS_dump
 af8:	48d9                	li	a7,22
  ecall
