...
cat(int fd)
{
  ...
  44:	91058593          	addi	a1,a1,-1776 # 950 <dump_test4_asm+0x44>
  48:	4509                	li	a0,2
  ...
  72:	8fa58593          	addi	a1,a1,-1798 # 968 <dump_test4_asm+0x5c>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 104:	88058593          	addi	a1,a1,-1920 # 980 <dump_test4_asm+0x74>
 108:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 492:	56a50513          	addi	a0,a0,1386 # 9f8 <digits>
 496:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 596:	40e70713          	addi	a4,a4,1038 # 9a0 <dump_test4_asm+0x94>
 ...
 620:	3dcb8b93          	addi	s7,s7,988 # 9f8 <digits>
 ...
 674:	32890913          	addi	s2,s2,808 # 998 <dump_test4_asm+0x8c>
        while(*s != 0){
...
00000000000008b0 <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000008cc <dump_test3_asm>:
...
dump_test3_asm:
 ...
 8ce:	59d1                	li	s3,-12
  li s4, 123
 8d0:	07b00a13          	li	s4,123
  li s5, -1234
 8d4:	b2e00a93          	li	s5,-1234
  li s6, 12345
 8d8:	6b0d                	lui	s6,0x3
 8da:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x1e29>
  li s7, -123456
 8de:	7b89                	lui	s7,0xfffe2
 8e0:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0bb0>
  li s8, 1234567
 8e4:	0012dc37          	lui	s8,0x12d
 8e8:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c477>
  li s9, -12345678
 8ec:	ff43acb7          	lui	s9,0xff43a
 8f0:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ca2>
  li s10, 123456789
 8f4:	075bdd37          	lui	s10,0x75bd
 8f8:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbb05>
  li s11, -1234567890
 8fc:	b66a0db7          	lui	s11,0xb66a0
 900:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669eb1e>
#ifdef SYS_dump
  li a7, SYS_dump
 904:	48d9                	li	a7,22
  ecall
...
000000000000090c <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 90c:	80000937          	lui	s2,0x80000
 910:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffedef>
  li s3, -2147483648
 912:	800009b7          	lui	s3,0x80000
  li s4, 1337
 916:	53900a13          	li	s4,1337
  li s5, 2020
 91a:	7e400a93          	li	s5,2020
  li s6, 3234
 91e:	6b05                	lui	s6,0x1
 920:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x2aa>
  li s7, 3235
 924:	6b85                	lui	s7,0x1
 926:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x2ab>
  li s8, 3236
 92a:	6c05                	lui	s8,0x1
 92c:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x2ac>
  li s9, 3237
 930:	6c85                	lui	s9,0x1
 932:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x2ad>
  li s10, 3238
 936:	6d05                	lui	s10,0x1
 938:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x2ae>
  li s11, 3239
 93c:	6d85                	lui	s11,0x1
 93e:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x2af>
#ifdef SYS_dump
  li a7, SYS_dump
 942:	48d9                	li	a7,22
  ecall
