...
main(int argc, char *argv[])
{
  ...
  1a:	95a78793          	addi	a5,a5,-1702 # 970 <dump_test4_asm+0x74>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	91450513          	addi	a0,a0,-1772 # 940 <dump_test4_asm+0x44>
  ...
  6c:	8f050513          	addi	a0,a0,-1808 # 958 <dump_test4_asm+0x5c>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8b250513          	addi	a0,a0,-1870 # 968 <dump_test4_asm+0x6c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 586:	40670713          	addi	a4,a4,1030 # 988 <dump_test4_asm+0x8c>
 ...
 610:	3d4b8b93          	addi	s7,s7,980 # 9e0 <digits>
 ...
 664:	32090913          	addi	s2,s2,800 # 980 <dump_test4_asm+0x84>
        while(*s != 0){
...
00000000000008a0 <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000008bc <dump_test3_asm>:
...
dump_test3_asm:
 ...
 8be:	59d1                	li	s3,-12
  li s4, 123
 8c0:	07b00a13          	li	s4,123
  li s5, -1234
 8c4:	b2e00a93          	li	s5,-1234
  li s6, 12345
 8c8:	6b0d                	lui	s6,0x3
 8ca:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 8ce:	7b89                	lui	s7,0xfffe2
 8d0:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 8d4:	0012dc37          	lui	s8,0x12d
 8d8:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 8dc:	ff43acb7          	lui	s9,0xff43a
 8e0:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 8e4:	075bdd37          	lui	s10,0x75bd
 8e8:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 8ec:	b66a0db7          	lui	s11,0xb66a0
 8f0:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 8f4:	48d9                	li	a7,22
  ecall
...
00000000000008fc <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 8fc:	80000937          	lui	s2,0x80000
 900:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 902:	800009b7          	lui	s3,0x80000
  li s4, 1337
 906:	53900a13          	li	s4,1337
  li s5, 2020
 90a:	7e400a93          	li	s5,2020
  li s6, 3234
 90e:	6b05                	lui	s6,0x1
 910:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x2c2>
  li s7, 3235
 914:	6b85                	lui	s7,0x1
 916:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x2c3>
  li s8, 3236
 91a:	6c05                	lui	s8,0x1
 91c:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x2c4>
  li s9, 3237
 920:	6c85                	lui	s9,0x1
 922:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x2c5>
  li s10, 3238
 926:	6d05                	lui	s10,0x1
 928:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x2c6>
  li s11, 3239
 92c:	6d85                	lui	s11,0x1
 92e:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x2c7>
#ifdef SYS_dump
  li a7, SYS_dump
 932:	48d9                	li	a7,22
  ecall
