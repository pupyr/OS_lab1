...
main(int argc, char *argv[])
{
  ...
  14:	88058593          	addi	a1,a1,-1920 # 890 <dump_test4_asm+0x40>
  18:	4509                	li	a0,2
  ...
  50:	85c58593          	addi	a1,a1,-1956 # 8a8 <dump_test4_asm+0x58>
  54:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	3f270713          	addi	a4,a4,1010 # 8c8 <dump_test4_asm+0x78>
 ...
 564:	3c0b8b93          	addi	s7,s7,960 # 920 <digits>
 ...
 5b8:	30c90913          	addi	s2,s2,780 # 8c0 <dump_test4_asm+0x70>
        while(*s != 0){
...
00000000000007f4 <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000000810 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 812:	59d1                	li	s3,-12
  li s4, 123
 814:	07b00a13          	li	s4,123
  li s5, -1234
 818:	b2e00a93          	li	s5,-1234
  li s6, 12345
 81c:	6b0d                	lui	s6,0x3
 81e:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 822:	7b89                	lui	s7,0xfffe2
 824:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 828:	0012dc37          	lui	s8,0x12d
 82c:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 830:	ff43acb7          	lui	s9,0xff43a
 834:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 838:	075bdd37          	lui	s10,0x75bd
 83c:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 840:	b66a0db7          	lui	s11,0xb66a0
 844:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 848:	48d9                	li	a7,22
  ecall
...
0000000000000850 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 850:	80000937          	lui	s2,0x80000
 854:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 856:	800009b7          	lui	s3,0x80000
  li s4, 1337
 85a:	53900a13          	li	s4,1337
  li s5, 2020
 85e:	7e400a93          	li	s5,2020
  li s6, 3234
 862:	6b05                	lui	s6,0x1
 864:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x382>
  li s7, 3235
 868:	6b85                	lui	s7,0x1
 86a:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x383>
  li s8, 3236
 86e:	6c05                	lui	s8,0x1
 870:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x384>
  li s9, 3237
 874:	6c85                	lui	s9,0x1
 876:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x385>
  li s10, 3238
 87a:	6d05                	lui	s10,0x1
 87c:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x386>
  li s11, 3239
 880:	6d85                	lui	s11,0x1
 882:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x387>
#ifdef SYS_dump
  li a7, SYS_dump
 886:	48d9                	li	a7,22
  ecall
