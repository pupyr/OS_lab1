...
main(int argc, char *argv[])
{
  ...
  40:	87458593          	addi	a1,a1,-1932 # 8b0 <dump_test4_asm+0x4a>
  44:	4509                	li	a0,2
  ...
  5e:	86e58593          	addi	a1,a1,-1938 # 8c8 <dump_test4_asm+0x62>
  62:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ec:	56050513          	addi	a0,a0,1376 # 948 <digits>
 3f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f0:	40470713          	addi	a4,a4,1028 # 8f0 <dump_test4_asm+0x8a>
 ...
 57a:	3d2b8b93          	addi	s7,s7,978 # 948 <digits>
 ...
 5ce:	31e90913          	addi	s2,s2,798 # 8e8 <dump_test4_asm+0x82>
        while(*s != 0){
...
000000000000080a <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000000826 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 828:	59d1                	li	s3,-12
  li s4, 123
 82a:	07b00a13          	li	s4,123
  li s5, -1234
 82e:	b2e00a93          	li	s5,-1234
  li s6, 12345
 832:	6b0d                	lui	s6,0x3
 834:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 838:	7b89                	lui	s7,0xfffe2
 83a:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 83e:	0012dc37          	lui	s8,0x12d
 842:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 846:	ff43acb7          	lui	s9,0xff43a
 84a:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 84e:	075bdd37          	lui	s10,0x75bd
 852:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 856:	b66a0db7          	lui	s11,0xb66a0
 85a:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 85e:	48d9                	li	a7,22
  ecall
...
0000000000000866 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 866:	80000937          	lui	s2,0x80000
 86a:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 86c:	800009b7          	lui	s3,0x80000
  li s4, 1337
 870:	53900a13          	li	s4,1337
  li s5, 2020
 874:	7e400a93          	li	s5,2020
  li s6, 3234
 878:	6b05                	lui	s6,0x1
 87a:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x35a>
  li s7, 3235
 87e:	6b85                	lui	s7,0x1
 880:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x35b>
  li s8, 3236
 884:	6c05                	lui	s8,0x1
 886:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x35c>
  li s9, 3237
 88a:	6c85                	lui	s9,0x1
 88c:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x35d>
  li s10, 3238
 890:	6d05                	lui	s10,0x1
 892:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x35e>
  li s11, 3239
 896:	6d85                	lui	s11,0x1
 898:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x35f>
#ifdef SYS_dump
  li a7, SYS_dump
 89c:	48d9                	li	a7,22
  ecall
