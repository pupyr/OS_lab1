...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	3c870713          	addi	a4,a4,968 # 868 <dump_test4_asm+0x4e>
 ...
 52e:	396b8b93          	addi	s7,s7,918 # 8c0 <digits>
 ...
 582:	2e290913          	addi	s2,s2,738 # 860 <dump_test4_asm+0x46>
        while(*s != 0){
...
00000000000007be <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000007da <dump_test3_asm>:
...
dump_test3_asm:
 ...
 7dc:	59d1                	li	s3,-12
  li s4, 123
 7de:	07b00a13          	li	s4,123
  li s5, -1234
 7e2:	b2e00a93          	li	s5,-1234
  li s6, 12345
 7e6:	6b0d                	lui	s6,0x3
 7e8:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 7ec:	7b89                	lui	s7,0xfffe2
 7ee:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 7f2:	0012dc37          	lui	s8,0x12d
 7f6:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 7fa:	ff43acb7          	lui	s9,0xff43a
 7fe:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 802:	075bdd37          	lui	s10,0x75bd
 806:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 80a:	b66a0db7          	lui	s11,0xb66a0
 80e:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 812:	48d9                	li	a7,22
  ecall
...
000000000000081a <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 81a:	80000937          	lui	s2,0x80000
 81e:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 820:	800009b7          	lui	s3,0x80000
  li s4, 1337
 824:	53900a13          	li	s4,1337
  li s5, 2020
 828:	7e400a93          	li	s5,2020
  li s6, 3234
 82c:	6b05                	lui	s6,0x1
 82e:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x3e2>
  li s7, 3235
 832:	6b85                	lui	s7,0x1
 834:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x3e3>
  li s8, 3236
 838:	6c05                	lui	s8,0x1
 83a:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x3e4>
  li s9, 3237
 83e:	6c85                	lui	s9,0x1
 840:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x3e5>
  li s10, 3238
 844:	6d05                	lui	s10,0x1
 846:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x3e6>
  li s11, 3239
 84a:	6d85                	lui	s11,0x1
 84c:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x3e7>
#ifdef SYS_dump
  li a7, SYS_dump
 850:	48d9                	li	a7,22
  ecall
