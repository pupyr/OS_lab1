...
main(int argc, char *argv[])
{
  ...
  34:	890a8a93          	addi	s5,s5,-1904 # 8c0 <dump_test4_asm+0x42>
  ...
  76:	85658593          	addi	a1,a1,-1962 # 8c8 <dump_test4_asm+0x4a>
  7a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 404:	53050513          	addi	a0,a0,1328 # 930 <digits>
 408:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 508:	3d470713          	addi	a4,a4,980 # 8d8 <dump_test4_asm+0x5a>
 ...
 592:	3a2b8b93          	addi	s7,s7,930 # 930 <digits>
 ...
 5e6:	2ee90913          	addi	s2,s2,750 # 8d0 <dump_test4_asm+0x52>
        while(*s != 0){
...
0000000000000822 <dump_test2_asm>:
#include "kernel/syscall.h"
...
000000000000083e <dump_test3_asm>:
...
dump_test3_asm:
 ...
 840:	59d1                	li	s3,-12
  li s4, 123
 842:	07b00a13          	li	s4,123
  li s5, -1234
 846:	b2e00a93          	li	s5,-1234
  li s6, 12345
 84a:	6b0d                	lui	s6,0x3
 84c:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 850:	7b89                	lui	s7,0xfffe2
 852:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 856:	0012dc37          	lui	s8,0x12d
 85a:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 85e:	ff43acb7          	lui	s9,0xff43a
 862:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 866:	075bdd37          	lui	s10,0x75bd
 86a:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 86e:	b66a0db7          	lui	s11,0xb66a0
 872:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 876:	48d9                	li	a7,22
  ecall
...
000000000000087e <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 87e:	80000937          	lui	s2,0x80000
 882:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 884:	800009b7          	lui	s3,0x80000
  li s4, 1337
 888:	53900a13          	li	s4,1337
  li s5, 2020
 88c:	7e400a93          	li	s5,2020
  li s6, 3234
 890:	6b05                	lui	s6,0x1
 892:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x372>
  li s7, 3235
 896:	6b85                	lui	s7,0x1
 898:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x373>
  li s8, 3236
 89c:	6c05                	lui	s8,0x1
 89e:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x374>
  li s9, 3237
 8a2:	6c85                	lui	s9,0x1
 8a4:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x375>
  li s10, 3238
 8a8:	6d05                	lui	s10,0x1
 8aa:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x376>
  li s11, 3239
 8ae:	6d85                	lui	s11,0x1
 8b0:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x377>
#ifdef SYS_dump
  li a7, SYS_dump
 8b4:	48d9                	li	a7,22
  ecall
