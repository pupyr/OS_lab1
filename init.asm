...
main(void)
{
  ...
  12:	92250513          	addi	a0,a0,-1758 # 930 <dump_test4_asm+0x48>
  ...
  3a:	90290913          	addi	s2,s2,-1790 # 938 <dump_test4_asm+0x50>
  3e:	854a                	mv	a0,s2
  ...
  6e:	91e50513          	addi	a0,a0,-1762 # 988 <dump_test4_asm+0xa0>
  ...
  8c:	8a850513          	addi	a0,a0,-1880 # 930 <dump_test4_asm+0x48>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	89650513          	addi	a0,a0,-1898 # 930 <dump_test4_asm+0x48>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	8a450513          	addi	a0,a0,-1884 # 950 <dump_test4_asm+0x68>
  ...
  d2:	89a50513          	addi	a0,a0,-1894 # 968 <dump_test4_asm+0x80>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	89250513          	addi	a0,a0,-1902 # 970 <dump_test4_asm+0x88>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	44270713          	addi	a4,a4,1090 # 9b0 <dump_test4_asm+0xc8>
 ...
 5fc:	410b8b93          	addi	s7,s7,1040 # a08 <digits>
 ...
 650:	35c90913          	addi	s2,s2,860 # 9a8 <dump_test4_asm+0xc0>
        while(*s != 0){
...
000000000000088c <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000008a8 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 8aa:	59d1                	li	s3,-12
  li s4, 123
 8ac:	07b00a13          	li	s4,123
  li s5, -1234
 8b0:	b2e00a93          	li	s5,-1234
  li s6, 12345
 8b4:	6b0d                	lui	s6,0x3
 8b6:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2019>
  li s7, -123456
 8ba:	7b89                	lui	s7,0xfffe2
 8bc:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0da0>
  li s8, 1234567
 8c0:	0012dc37          	lui	s8,0x12d
 8c4:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c667>
  li s9, -12345678
 8c8:	ff43acb7          	lui	s9,0xff43a
 8cc:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438e92>
  li s10, 123456789
 8d0:	075bdd37          	lui	s10,0x75bd
 8d4:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbcf5>
  li s11, -1234567890
 8d8:	b66a0db7          	lui	s11,0xb66a0
 8dc:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed0e>
#ifdef SYS_dump
  li a7, SYS_dump
 8e0:	48d9                	li	a7,22
  ecall
...
00000000000008e8 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 8e8:	80000937          	lui	s2,0x80000
 8ec:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefdf>
  li s3, -2147483648
 8ee:	800009b7          	lui	s3,0x80000
  li s4, 1337
 8f2:	53900a13          	li	s4,1337
  li s5, 2020
 8f6:	7e400a93          	li	s5,2020
  li s6, 3234
 8fa:	6b05                	lui	s6,0x1
 8fc:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x29a>
  li s7, 3235
 900:	6b85                	lui	s7,0x1
 902:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x29b>
  li s8, 3236
 906:	6c05                	lui	s8,0x1
 908:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x29c>
  li s9, 3237
 90c:	6c85                	lui	s9,0x1
 90e:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x29d>
  li s10, 3238
 912:	6d05                	lui	s10,0x1
 914:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x29e>
  li s11, 3239
 918:	6d85                	lui	s11,0x1
 91a:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x29f>
#ifdef SYS_dump
  li a7, SYS_dump
 91e:	48d9                	li	a7,22
  ecall
