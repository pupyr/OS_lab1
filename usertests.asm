...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	10250513          	addi	a0,a0,258 # 6140 <dump_test4_asm+0x48>
      ...
      74:	8082                	ret
{
      ...
      84:	0e050513          	addi	a0,a0,224 # 6160 <dump_test4_asm+0x68>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0d050513          	addi	a0,a0,208 # 6178 <dump_test4_asm+0x80>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0d250513          	addi	a0,a0,210 # 6198 <dump_test4_asm+0xa0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	09a50513          	addi	a0,a0,154 # 6180 <dump_test4_asm+0x88>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0a650513          	addi	a0,a0,166 # 61a8 <dump_test4_asm+0xb0>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0a450513          	addi	a0,a0,164 # 61d0 <dump_test4_asm+0xd8>
     134:	00006097          	auipc	ra,0x6
     138:	aaa080e7          	jalr	-1366(ra) # 5bde <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	09050513          	addi	a0,a0,144 # 61d0 <dump_test4_asm+0xd8>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	08c58593          	addi	a1,a1,140 # 61e0 <dump_test4_asm+0xe8>
     15c:	00006097          	auipc	ra,0x6
     160:	a52080e7          	jalr	-1454(ra) # 5bae <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	06850513          	addi	a0,a0,104 # 61d0 <dump_test4_asm+0xd8>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	06c58593          	addi	a1,a1,108 # 61e8 <dump_test4_asm+0xf0>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	03c50513          	addi	a0,a0,60 # 61d0 <dump_test4_asm+0xd8>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	02650513          	addi	a0,a0,38 # 61f0 <dump_test4_asm+0xf8>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f9c50513          	addi	a0,a0,-100 # 6218 <dump_test4_asm+0x120>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f88a8a93          	addi	s5,s5,-120 # 6218 <dump_test4_asm+0x120>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f1650513          	addi	a0,a0,-234 # 6228 <dump_test4_asm+0x130>
     ...
     338:	f1450513          	addi	a0,a0,-236 # 6248 <dump_test4_asm+0x150>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f0250513          	addi	a0,a0,-254 # 6260 <dump_test4_asm+0x168>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	eee98993          	addi	s3,s3,-274 # 6260 <dump_test4_asm+0x168>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	ea250513          	addi	a0,a0,-350 # 6260 <dump_test4_asm+0x168>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e1258593          	addi	a1,a1,-494 # 61e8 <dump_test4_asm+0xf0>
    ...
    printf("write failed\n");
     ...
     3f0:	e9450513          	addi	a0,a0,-364 # 6280 <dump_test4_asm+0x188>
    ...
    exit(1);
     ...
     40a:	e6250513          	addi	a0,a0,-414 # 6268 <dump_test4_asm+0x170>
    ...
    printf("open junk failed\n");
     ...
     424:	e4850513          	addi	a0,a0,-440 # 6268 <dump_test4_asm+0x170>
  ...
  unlink("junk");
     ...
     448:	e1c50513          	addi	a0,a0,-484 # 6260 <dump_test4_asm+0x168>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d40a0a13          	addi	s4,s4,-704 # 6290 <dump_test4_asm+0x198>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c9c50513          	addi	a0,a0,-868 # 6298 <dump_test4_asm+0x1a0>
     ...
     61e:	c9650513          	addi	a0,a0,-874 # 62b0 <dump_test4_asm+0x1b8>
     ...
     63c:	ca850513          	addi	a0,a0,-856 # 62e0 <dump_test4_asm+0x1e8>
     ...
     656:	cbe50513          	addi	a0,a0,-834 # 6310 <dump_test4_asm+0x218>
     ...
     674:	cb050513          	addi	a0,a0,-848 # 6320 <dump_test4_asm+0x228>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	ca2a0a13          	addi	s4,s4,-862 # 6350 <dump_test4_asm+0x258>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b32a8a93          	addi	s5,s5,-1230 # 61e8 <dump_test4_asm+0xf0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bfc50513          	addi	a0,a0,-1028 # 6358 <dump_test4_asm+0x260>
     ...
     77e:	bf650513          	addi	a0,a0,-1034 # 6370 <dump_test4_asm+0x278>
     ...
     798:	b7c50513          	addi	a0,a0,-1156 # 6310 <dump_test4_asm+0x218>
     ...
     7b2:	bf250513          	addi	a0,a0,-1038 # 63a0 <dump_test4_asm+0x2a8>
     ...
     7d0:	bec50513          	addi	a0,a0,-1044 # 63b8 <dump_test4_asm+0x2c0>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	9be58593          	addi	a1,a1,-1602 # 61e0 <dump_test4_asm+0xe8>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	99250513          	addi	a0,a0,-1646 # 61d0 <dump_test4_asm+0xd8>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	96650513          	addi	a0,a0,-1690 # 61d0 <dump_test4_asm+0xd8>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	95250513          	addi	a0,a0,-1710 # 61d0 <dump_test4_asm+0xd8>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b8c58593          	addi	a1,a1,-1140 # 6448 <dump_test4_asm+0x350>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8d250513          	addi	a0,a0,-1838 # 61d0 <dump_test4_asm+0xd8>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	aa650513          	addi	a0,a0,-1370 # 63e8 <dump_test4_asm+0x2f0>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	aaa50513          	addi	a0,a0,-1366 # 6408 <dump_test4_asm+0x310>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	aa650513          	addi	a0,a0,-1370 # 6418 <dump_test4_asm+0x320>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	aaa50513          	addi	a0,a0,-1366 # 6438 <dump_test4_asm+0x340>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a7650513          	addi	a0,a0,-1418 # 6418 <dump_test4_asm+0x320>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a9050513          	addi	a0,a0,-1392 # 6450 <dump_test4_asm+0x358>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a9250513          	addi	a0,a0,-1390 # 6470 <dump_test4_asm+0x378>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a7e50513          	addi	a0,a0,-1410 # 6490 <dump_test4_asm+0x398>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a8e98993          	addi	s3,s3,-1394 # 64b8 <dump_test4_asm+0x3c0>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	abea8a93          	addi	s5,s5,-1346 # 64f0 <dump_test4_asm+0x3f8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a1850513          	addi	a0,a0,-1512 # 6490 <dump_test4_asm+0x398>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9dc50513          	addi	a0,a0,-1572 # 6490 <dump_test4_asm+0x398>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	9ba50513          	addi	a0,a0,-1606 # 6498 <dump_test4_asm+0x3a0>
    ...
    exit(1);
     ...
     b00:	9cc50513          	addi	a0,a0,-1588 # 64c8 <dump_test4_asm+0x3d0>
     ...
     b1e:	9e650513          	addi	a0,a0,-1562 # 6500 <dump_test4_asm+0x408>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9f250513          	addi	a0,a0,-1550 # 6528 <dump_test4_asm+0x430>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9f650513          	addi	a0,a0,-1546 # 6548 <dump_test4_asm+0x450>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9f250513          	addi	a0,a0,-1550 # 6560 <dump_test4_asm+0x468>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9e050513          	addi	a0,a0,-1568 # 6580 <dump_test4_asm+0x488>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	98e50513          	addi	a0,a0,-1650 # 6580 <dump_test4_asm+0x488>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	94e50513          	addi	a0,a0,-1714 # 6588 <dump_test4_asm+0x490>
    ...
    exit(1);
     ...
     c5c:	95050513          	addi	a0,a0,-1712 # 65a8 <dump_test4_asm+0x4b0>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	95c50513          	addi	a0,a0,-1700 # 65d0 <dump_test4_asm+0x4d8>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8e050513          	addi	a0,a0,-1824 # 6580 <dump_test4_asm+0x488>
     ...
     cd0:	92450513          	addi	a0,a0,-1756 # 65f0 <dump_test4_asm+0x4f8>
     ...
     cee:	92e50513          	addi	a0,a0,-1746 # 6618 <dump_test4_asm+0x520>
     ...
     d0c:	92850513          	addi	a0,a0,-1752 # 6630 <dump_test4_asm+0x538>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	93450513          	addi	a0,a0,-1740 # 6658 <dump_test4_asm+0x560>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	91e50513          	addi	a0,a0,-1762 # 6670 <dump_test4_asm+0x578>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	93658593          	addi	a1,a1,-1738 # 66a0 <dump_test4_asm+0x5a8>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ea50513          	addi	a0,a0,-1814 # 6670 <dump_test4_asm+0x578>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8d450513          	addi	a0,a0,-1836 # 6670 <dump_test4_asm+0x578>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	8be50513          	addi	a0,a0,-1858 # 6670 <dump_test4_asm+0x578>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	92258593          	addi	a1,a1,-1758 # 66e8 <dump_test4_asm+0x5f0>
  ...
  unlink("unlinkread");
     ...
     e32:	84250513          	addi	a0,a0,-1982 # 6670 <dump_test4_asm+0x578>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	83250513          	addi	a0,a0,-1998 # 6680 <dump_test4_asm+0x588>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	83e50513          	addi	a0,a0,-1986 # 66a8 <dump_test4_asm+0x5b0>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	84250513          	addi	a0,a0,-1982 # 66c8 <dump_test4_asm+0x5d0>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	84e50513          	addi	a0,a0,-1970 # 66f0 <dump_test4_asm+0x5f8>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	85250513          	addi	a0,a0,-1966 # 6710 <dump_test4_asm+0x618>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	85650513          	addi	a0,a0,-1962 # 6730 <dump_test4_asm+0x638>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	76258593          	addi	a1,a1,1890 # 66a0 <dump_test4_asm+0x5a8>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7fa58593          	addi	a1,a1,2042 # 6758 <dump_test4_asm+0x660>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ea50513          	addi	a0,a0,2026 # 6750 <dump_test4_asm+0x658>
  ...
  unlink("lf1");
     ...
     f7e:	7d650513          	addi	a0,a0,2006 # 6750 <dump_test4_asm+0x658>
     f82:	00005097          	auipc	ra,0x5
     f86:	c5c080e7          	jalr	-932(ra) # 5bde <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7c450513          	addi	a0,a0,1988 # 6750 <dump_test4_asm+0x658>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	7b650513          	addi	a0,a0,1974 # 6758 <dump_test4_asm+0x660>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	77e58593          	addi	a1,a1,1918 # 6758 <dump_test4_asm+0x660>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	76850513          	addi	a0,a0,1896 # 6758 <dump_test4_asm+0x660>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	be6080e7          	jalr	-1050(ra) # 5bde <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	75058593          	addi	a1,a1,1872 # 6750 <dump_test4_asm+0x658>
    1008:	00005517          	auipc	a0,0x5
    100c:	75050513          	addi	a0,a0,1872 # 6758 <dump_test4_asm+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	73458593          	addi	a1,a1,1844 # 6750 <dump_test4_asm+0x658>
    1024:	00006517          	auipc	a0,0x6
    1028:	83c50513          	addi	a0,a0,-1988 # 6860 <dump_test4_asm+0x768>
    ...
    104a:	71a50513          	addi	a0,a0,1818 # 6760 <dump_test4_asm+0x668>
    ...
    1066:	71650513          	addi	a0,a0,1814 # 6778 <dump_test4_asm+0x680>
    ...
    1082:	71250513          	addi	a0,a0,1810 # 6790 <dump_test4_asm+0x698>
    ...
    109e:	71650513          	addi	a0,a0,1814 # 67b0 <dump_test4_asm+0x6b8>
    ...
    10ba:	72a50513          	addi	a0,a0,1834 # 67e0 <dump_test4_asm+0x6e8>
    ...
    10d6:	72650513          	addi	a0,a0,1830 # 67f8 <dump_test4_asm+0x700>
    ...
    10f2:	72250513          	addi	a0,a0,1826 # 6810 <dump_test4_asm+0x718>
    ...
    110e:	72e50513          	addi	a0,a0,1838 # 6838 <dump_test4_asm+0x740>
    ...
    112a:	74250513          	addi	a0,a0,1858 # 6868 <dump_test4_asm+0x770>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	73098993          	addi	s3,s3,1840 # 6888 <dump_test4_asm+0x790>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	70450513          	addi	a0,a0,1796 # 6898 <dump_test4_asm+0x7a0>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	6bea0a13          	addi	s4,s4,1726 # 68b8 <dump_test4_asm+0x7c0>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	66c50513          	addi	a0,a0,1644 # 68b8 <dump_test4_asm+0x7c0>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	60450513          	addi	a0,a0,1540 # 68c0 <dump_test4_asm+0x7c8>
    ...
    12e0:	60450513          	addi	a0,a0,1540 # 68e0 <dump_test4_asm+0x7e8>
    ...
    12fc:	60850513          	addi	a0,a0,1544 # 6900 <dump_test4_asm+0x808>
...
000000000000134a <badarg>:
{
    ...
    1368:	e1498993          	addi	s3,s3,-492 # 6178 <dump_test4_asm+0x80>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	76a78793          	addi	a5,a5,1898 # 7b58 <dump_test4_asm+0x1a60>
  ...
  if(pid == 0){
    ...
    144e:	14e78793          	addi	a5,a5,334 # 8598 <dump_test4_asm+0x24a0>
    ...
    1472:	d0a50513          	addi	a0,a0,-758 # 6178 <dump_test4_asm+0x80>
    ...
    148a:	52250513          	addi	a0,a0,1314 # 69a8 <dump_test4_asm+0x8b0>
    ...
    14aa:	47a50513          	addi	a0,a0,1146 # 6920 <dump_test4_asm+0x828>
    ...
    14ca:	47a50513          	addi	a0,a0,1146 # 6940 <dump_test4_asm+0x848>
    ...
    14ec:	47850513          	addi	a0,a0,1144 # 6960 <dump_test4_asm+0x868>
    ...
    150c:	48050513          	addi	a0,a0,1152 # 6988 <dump_test4_asm+0x890>
    ...
    1526:	8e650513          	addi	a0,a0,-1818 # 6e08 <dump_test4_asm+0xd10>
  ...
  if(st != 747){
    ...
    1570:	46450513          	addi	a0,a0,1124 # 69d0 <dump_test4_asm+0x8d8>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c3250513          	addi	a0,a0,-974 # 61d0 <dump_test4_asm+0xd8>
  ...
  if(pid == 0){
    ...
    15cc:	c08a0a13          	addi	s4,s4,-1016 # 61d0 <dump_test4_asm+0xd8>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	460a8a93          	addi	s5,s5,1120 # 6a30 <dump_test4_asm+0x938>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	3c050513          	addi	a0,a0,960 # 6a00 <dump_test4_asm+0x908>
    ...
    1660:	3bc50513          	addi	a0,a0,956 # 6a18 <dump_test4_asm+0x920>
    ...
    167e:	3c650513          	addi	a0,a0,966 # 6a40 <dump_test4_asm+0x948>
    ...
    169c:	b38a0a13          	addi	s4,s4,-1224 # 61d0 <dump_test4_asm+0xd8>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	3c0a8a93          	addi	s5,s5,960 # 6a60 <dump_test4_asm+0x968>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	ae650513          	addi	a0,a0,-1306 # 61d0 <dump_test4_asm+0xd8>
  ...
  exit(xstatus);
    ...
    170c:	31050513          	addi	a0,a0,784 # 6a18 <dump_test4_asm+0x920>
    ...
    172a:	34250513          	addi	a0,a0,834 # 6a68 <dump_test4_asm+0x970>
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	a2a78793          	addi	a5,a5,-1494 # 6178 <dump_test4_asm+0x80>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	32e78793          	addi	a5,a5,814 # 6a88 <dump_test4_asm+0x990>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	32650513          	addi	a0,a0,806 # 6a90 <dump_test4_asm+0x998>
  ...
  if(pid == 0) {
    ...
    179c:	2f850513          	addi	a0,a0,760 # 6a90 <dump_test4_asm+0x998>
    ...
    17b8:	2fc50513          	addi	a0,a0,764 # 6ab0 <dump_test4_asm+0x9b8>
    ...
    17d4:	23050513          	addi	a0,a0,560 # 6a00 <dump_test4_asm+0x908>
    ...
    17f0:	2ac50513          	addi	a0,a0,684 # 6a98 <dump_test4_asm+0x9a0>
    ...
    180e:	96e50513          	addi	a0,a0,-1682 # 6178 <dump_test4_asm+0x80>
  ...
  if(xstatus != 0)
    ...
    1842:	28250513          	addi	a0,a0,642 # 6ac0 <dump_test4_asm+0x9c8>
    ...
    185e:	27e50513          	addi	a0,a0,638 # 6ad8 <dump_test4_asm+0x9e0>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	22250513          	addi	a0,a0,546 # 6a90 <dump_test4_asm+0x998>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	cb050513          	addi	a0,a0,-848 # 6548 <dump_test4_asm+0x450>
    ...
    18b8:	16450513          	addi	a0,a0,356 # 6a18 <dump_test4_asm+0x920>
  ...
  unlink("echo-ok");
    ...
    18d2:	1c250513          	addi	a0,a0,450 # 6a90 <dump_test4_asm+0x998>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	1f850513          	addi	a0,a0,504 # 6af0 <dump_test4_asm+0x9f8>
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	15050513          	addi	a0,a0,336 # 6b08 <dump_test4_asm+0xa10>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	0e250513          	addi	a0,a0,226 # 6b20 <dump_test4_asm+0xa28>
    ...
    1a5e:	0de50513          	addi	a0,a0,222 # 6b38 <dump_test4_asm+0xa40>
    ...
    1a90:	0c450513          	addi	a0,a0,196 # 6b50 <dump_test4_asm+0xa58>
    ...
    1ad0:	0a450513          	addi	a0,a0,164 # 6b70 <dump_test4_asm+0xa78>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	ec250513          	addi	a0,a0,-318 # 6a00 <dump_test4_asm+0x908>
    ...
    1b5e:	02e50513          	addi	a0,a0,46 # 6b88 <dump_test4_asm+0xa90>
    ...
    1b7a:	02a50513          	addi	a0,a0,42 # 6ba0 <dump_test4_asm+0xaa8>
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	e1250513          	addi	a0,a0,-494 # 6a00 <dump_test4_asm+0x908>
    ...
    1c16:	dee50513          	addi	a0,a0,-530 # 6a00 <dump_test4_asm+0x908>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f3450513          	addi	a0,a0,-204 # 6bc0 <dump_test4_asm+0xac8>
    ...
    1ca2:	ef0080e7          	jalr	-272(ra) # 5b8e <exit>
{
    ...
    1ce8:	eec50513          	addi	a0,a0,-276 # 6bd0 <dump_test4_asm+0xad8>
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	0d650513          	addi	a0,a0,214 # 6e08 <dump_test4_asm+0xd10>
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	03850513          	addi	a0,a0,56 # 6e08 <dump_test4_asm+0xd10>
    ...
    1e00:	c9c50513          	addi	a0,a0,-868 # 6a98 <dump_test4_asm+0x9a0>
    ...
    1e72:	d8250513          	addi	a0,a0,-638 # 6bf0 <dump_test4_asm+0xaf8>
    ...
    1ea6:	d6650513          	addi	a0,a0,-666 # 6c08 <dump_test4_asm+0xb10>
    ...
    1f0c:	d2850513          	addi	a0,a0,-728 # 6c30 <dump_test4_asm+0xb38>
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	24050513          	addi	a0,a0,576 # 61e8 <dump_test4_asm+0xf0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	204a8a93          	addi	s5,s5,516 # 61e8 <dump_test4_asm+0xf0>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c6cb8b93          	addi	s7,s7,-916 # 6c58 <dump_test4_asm+0xb60>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	a0850513          	addi	a0,a0,-1528 # 6a00 <dump_test4_asm+0x908>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	bbe50513          	addi	a0,a0,-1090 # 6c78 <dump_test4_asm+0xb80>
  ...
  if(wait(0) != -1){
    ...
    2120:	b4450513          	addi	a0,a0,-1212 # 6c60 <dump_test4_asm+0xb68>
    ...
    213c:	b6850513          	addi	a0,a0,-1176 # 6ca0 <dump_test4_asm+0xba8>
    ...
    2158:	b6450513          	addi	a0,a0,-1180 # 6cb8 <dump_test4_asm+0xbc0>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	82c50513          	addi	a0,a0,-2004 # 6a00 <dump_test4_asm+0x908>
    ...
    21fa:	ada50513          	addi	a0,a0,-1318 # 6cd0 <dump_test4_asm+0xbd8>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	78850513          	addi	a0,a0,1928 # 6a00 <dump_test4_asm+0x908>
    ...
    22a8:	a4c50513          	addi	a0,a0,-1460 # 6cf0 <dump_test4_asm+0xbf8>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a3450513          	addi	a0,a0,-1484 # 6d08 <dump_test4_asm+0xc10>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	a0250513          	addi	a0,a0,-1534 # 6d08 <dump_test4_asm+0xc10>
  ...
  close(fd);
    ...
    2340:	9dc70713          	addi	a4,a4,-1572 # 6d18 <dump_test4_asm+0xc20>
    ...
    2394:	a6850513          	addi	a0,a0,-1432 # 6df8 <dump_test4_asm+0xd00>
    ...
    23b8:	a6450513          	addi	a0,a0,-1436 # 6e18 <dump_test4_asm+0xd20>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	a2650513          	addi	a0,a0,-1498 # 6e38 <dump_test4_asm+0xd40>
    ...
    2432:	5d250513          	addi	a0,a0,1490 # 6a00 <dump_test4_asm+0x908>
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	56450513          	addi	a0,a0,1380 # 6a00 <dump_test4_asm+0x908>
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	8f050513          	addi	a0,a0,-1808 # 6e08 <dump_test4_asm+0xd10>
    ...
    25cc:	89850513          	addi	a0,a0,-1896 # 6e60 <dump_test4_asm+0xd68>
    ...
    25ec:	c6050513          	addi	a0,a0,-928 # 6248 <dump_test4_asm+0x150>
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	4d878793          	addi	a5,a5,1240 # 7b58 <dump_test4_asm+0x1a60>
  ...
  if(ret != -1){
    ...
    26c6:	7b650513          	addi	a0,a0,1974 # 6e78 <dump_test4_asm+0xd80>
    ...
    26e4:	24050513          	addi	a0,a0,576 # 6920 <dump_test4_asm+0x828>
    ...
    2702:	24250513          	addi	a0,a0,578 # 6940 <dump_test4_asm+0x848>
    ...
    2722:	24250513          	addi	a0,a0,578 # 6960 <dump_test4_asm+0x868>
    ...
    2740:	24c50513          	addi	a0,a0,588 # 6988 <dump_test4_asm+0x890>
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	73050513          	addi	a0,a0,1840 # 6eb8 <dump_test4_asm+0xdc0>
  ...
  if(n >= 0){
    ...
    27bc:	72050513          	addi	a0,a0,1824 # 6ed8 <dump_test4_asm+0xde0>
    ...
    27d6:	6ae50513          	addi	a0,a0,1710 # 6e80 <dump_test4_asm+0xd88>
    ...
    27f0:	6ac50513          	addi	a0,a0,1708 # 6e98 <dump_test4_asm+0xda0>
    ...
    280a:	6ba50513          	addi	a0,a0,1722 # 6ec0 <dump_test4_asm+0xdc8>
  ...
  unlink("rwsbrk");
    ...
    282e:	68e50513          	addi	a0,a0,1678 # 6eb8 <dump_test4_asm+0xdc0>
    2832:	00003097          	auipc	ra,0x3
    2836:	3ac080e7          	jalr	940(ra) # 5bde <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	b1450513          	addi	a0,a0,-1260 # 6350 <dump_test4_asm+0x258>
  ...
  if(n >= 0){
    ...
    286a:	6a250513          	addi	a0,a0,1698 # 6f08 <dump_test4_asm+0xe10>
    ...
    2884:	64050513          	addi	a0,a0,1600 # 6ec0 <dump_test4_asm+0xdc8>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	63050513          	addi	a0,a0,1584 # 6f30 <dump_test4_asm+0xe38>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	5fe50513          	addi	a0,a0,1534 # 6f50 <dump_test4_asm+0xe58>
  ...
  if(c != a + 1){
    ...
    29ba:	5fa50513          	addi	a0,a0,1530 # 6fb0 <dump_test4_asm+0xeb8>
    ...
    29dc:	59850513          	addi	a0,a0,1432 # 6f70 <dump_test4_asm+0xe78>
    ...
    29f8:	59c50513          	addi	a0,a0,1436 # 6f90 <dump_test4_asm+0xe98>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	49250513          	addi	a0,a0,1170 # 6fd0 <dump_test4_asm+0xed8>
    ...
    2b5e:	4be50513          	addi	a0,a0,1214 # 7018 <dump_test4_asm+0xf20>
    ...
    2b7e:	4be50513          	addi	a0,a0,1214 # 7038 <dump_test4_asm+0xf40>
    ...
    2b9e:	4de50513          	addi	a0,a0,1246 # 7078 <dump_test4_asm+0xf80>
    ...
    2bba:	4f250513          	addi	a0,a0,1266 # 70a8 <dump_test4_asm+0xfb0>
    ...
    2bda:	50a50513          	addi	a0,a0,1290 # 70e0 <dump_test4_asm+0xfe8>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	4f850513          	addi	a0,a0,1272 # 7108 <dump_test4_asm+0x1010>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fb6080e7          	jalr	-74(ra) # 5bce <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	4e650513          	addi	a0,a0,1254 # 7108 <dump_test4_asm+0x1010>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	49a50513          	addi	a0,a0,1178 # 7110 <dump_test4_asm+0x1018>
    ...
    2c96:	49650513          	addi	a0,a0,1174 # 7128 <dump_test4_asm+0x1030>
    ...
    2cb2:	e5a50513          	addi	a0,a0,-422 # 6b08 <dump_test4_asm+0xa10>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	46850513          	addi	a0,a0,1128 # 7140 <dump_test4_asm+0x1048>
  ...
  close(fd);
    ...
    2d24:	cf850513          	addi	a0,a0,-776 # 6a18 <dump_test4_asm+0x920>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	09a50513          	addi	a0,a0,154 # 6e08 <dump_test4_asm+0xd10>
  ...
  if(pid == 0){
    ...
    2dc8:	04450513          	addi	a0,a0,68 # 6e08 <dump_test4_asm+0xd10>
  ...
  if(pid == 0){
    ...
    2e28:	fe450513          	addi	a0,a0,-28 # 6e08 <dump_test4_asm+0xd10>
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e7050513          	addi	a0,a0,-400 # 6e08 <dump_test4_asm+0xd10>
    ...
    2ff0:	18c50513          	addi	a0,a0,396 # 6178 <dump_test4_asm+0x80>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	1f078793          	addi	a5,a5,496 # 61e8 <dump_test4_asm+0xf0>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	2ee50513          	addi	a0,a0,750 # 7318 <dump_test4_asm+0x1220>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	13450513          	addi	a0,a0,308 # 7170 <dump_test4_asm+0x1078>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	17650513          	addi	a0,a0,374 # 71c8 <dump_test4_asm+0x10d0>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	1d050513          	addi	a0,a0,464 # 7240 <dump_test4_asm+0x1148>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	22450513          	addi	a0,a0,548 # 72b0 <dump_test4_asm+0x11b8>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	26a50513          	addi	a0,a0,618 # 7308 <dump_test4_asm+0x1210>
  ...
  unlink("12345678901234");
    ...
    3120:	02c50513          	addi	a0,a0,44 # 7148 <dump_test4_asm+0x1050>
    ...
    313c:	05850513          	addi	a0,a0,88 # 7190 <dump_test4_asm+0x1098>
    ...
    3158:	0a450513          	addi	a0,a0,164 # 71f8 <dump_test4_asm+0x1100>
    ...
    3174:	10050513          	addi	a0,a0,256 # 7270 <dump_test4_asm+0x1178>
    ...
    3190:	14450513          	addi	a0,a0,324 # 72d0 <dump_test4_asm+0x11d8>
    ...
    31ac:	18050513          	addi	a0,a0,384 # 7328 <dump_test4_asm+0x1230>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	16c50513          	addi	a0,a0,364 # 7360 <dump_test4_asm+0x1268>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	15250513          	addi	a0,a0,338 # 7370 <dump_test4_asm+0x1278>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	0b250513          	addi	a0,a0,178 # 7360 <dump_test4_asm+0x1268>
  ...
  unlink("diskfulldir");
    ...
    32c6:	09e50513          	addi	a0,a0,158 # 7360 <dump_test4_asm+0x1268>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	fa050513          	addi	a0,a0,-96 # 7390 <dump_test4_asm+0x1298>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	fb250513          	addi	a0,a0,-78 # 73c0 <dump_test4_asm+0x12c8>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f9e50513          	addi	a0,a0,-98 # 73c0 <dump_test4_asm+0x12c8>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	fca50513          	addi	a0,a0,-54 # 7400 <dump_test4_asm+0x1308>
  ...
  if(chdir("/") < 0){
    ...
    344e:	fe650513          	addi	a0,a0,-26 # 7430 <dump_test4_asm+0x1338>
    ...
    346e:	f5e50513          	addi	a0,a0,-162 # 73c8 <dump_test4_asm+0x12d0>
    ...
    348a:	f5a50513          	addi	a0,a0,-166 # 73e0 <dump_test4_asm+0x12e8>
    ...
    34a6:	f6e50513          	addi	a0,a0,-146 # 7410 <dump_test4_asm+0x1318>
    ...
    34c2:	f7a50513          	addi	a0,a0,-134 # 7438 <dump_test4_asm+0x1340>
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	ece50513          	addi	a0,a0,-306 # 73c0 <dump_test4_asm+0x12c8>
    ...
    350a:	eba50513          	addi	a0,a0,-326 # 73c0 <dump_test4_asm+0x12c8>
    ...
    351e:	ee650513          	addi	a0,a0,-282 # 7400 <dump_test4_asm+0x1308>
    ...
    353e:	4c650513          	addi	a0,a0,1222 # 6a00 <dump_test4_asm+0x908>
    ...
    355a:	e7250513          	addi	a0,a0,-398 # 73c8 <dump_test4_asm+0x12d0>
    ...
    3576:	ede50513          	addi	a0,a0,-290 # 7450 <dump_test4_asm+0x1358>
    ...
    3592:	e8250513          	addi	a0,a0,-382 # 7410 <dump_test4_asm+0x1318>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e9c50513          	addi	a0,a0,-356 # 7468 <dump_test4_asm+0x1370>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e8850513          	addi	a0,a0,-376 # 7468 <dump_test4_asm+0x1370>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e9450513          	addi	a0,a0,-364 # 7488 <dump_test4_asm+0x1390>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e6050513          	addi	a0,a0,-416 # 7468 <dump_test4_asm+0x1370>
    ...
    362c:	da050513          	addi	a0,a0,-608 # 73c8 <dump_test4_asm+0x12d0>
    ...
    3648:	e2c50513          	addi	a0,a0,-468 # 7470 <dump_test4_asm+0x1378>
    ...
    3664:	e3050513          	addi	a0,a0,-464 # 7490 <dump_test4_asm+0x1398>
    ...
    3680:	e2c50513          	addi	a0,a0,-468 # 74a8 <dump_test4_asm+0x13b0>
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f4c50513          	addi	a0,a0,-180 # 75f0 <dump_test4_asm+0x14f8>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	532080e7          	jalr	1330(ra) # 5bde <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	e0c50513          	addi	a0,a0,-500 # 74c0 <dump_test4_asm+0x13c8>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	e1450513          	addi	a0,a0,-492 # 74e0 <dump_test4_asm+0x13e8>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	f0c58593          	addi	a1,a1,-244 # 75f0 <dump_test4_asm+0x14f8>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	dc250513          	addi	a0,a0,-574 # 74c0 <dump_test4_asm+0x13c8>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	e2650513          	addi	a0,a0,-474 # 7538 <dump_test4_asm+0x1440>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e3650513          	addi	a0,a0,-458 # 7560 <dump_test4_asm+0x1468>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e4e58593          	addi	a1,a1,-434 # 7590 <dump_test4_asm+0x1498>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e3a50513          	addi	a0,a0,-454 # 7598 <dump_test4_asm+0x14a0>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e4258593          	addi	a1,a1,-446 # 75e8 <dump_test4_asm+0x14f0>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	db250513          	addi	a0,a0,-590 # 7560 <dump_test4_asm+0x1468>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d9e50513          	addi	a0,a0,-610 # 7560 <dump_test4_asm+0x1468>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d8850513          	addi	a0,a0,-632 # 7560 <dump_test4_asm+0x1468>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	cd450513          	addi	a0,a0,-812 # 74c0 <dump_test4_asm+0x13c8>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e8050513          	addi	a0,a0,-384 # 7680 <dump_test4_asm+0x1588>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e9c50513          	addi	a0,a0,-356 # 76b0 <dump_test4_asm+0x15b8>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	eb850513          	addi	a0,a0,-328 # 76e0 <dump_test4_asm+0x15e8>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	daa50513          	addi	a0,a0,-598 # 75e8 <dump_test4_asm+0x14f0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	ce850513          	addi	a0,a0,-792 # 7560 <dump_test4_asm+0x1468>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	ee050513          	addi	a0,a0,-288 # 7770 <dump_test4_asm+0x1678>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	ef850513          	addi	a0,a0,-264 # 77a0 <dump_test4_asm+0x16a8>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	c0050513          	addi	a0,a0,-1024 # 74c0 <dump_test4_asm+0x13c8>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	bea50513          	addi	a0,a0,-1046 # 74c0 <dump_test4_asm+0x13c8>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	bd450513          	addi	a0,a0,-1068 # 74c0 <dump_test4_asm+0x13c8>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f3058593          	addi	a1,a1,-208 # 7830 <dump_test4_asm+0x1738>
    3908:	00004517          	auipc	a0,0x4
    390c:	e6850513          	addi	a0,a0,-408 # 7770 <dump_test4_asm+0x1678>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	f1458593          	addi	a1,a1,-236 # 7830 <dump_test4_asm+0x1738>
    3924:	00004517          	auipc	a0,0x4
    3928:	e7c50513          	addi	a0,a0,-388 # 77a0 <dump_test4_asm+0x16a8>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	cb058593          	addi	a1,a1,-848 # 75e8 <dump_test4_asm+0x14f0>
    3940:	00004517          	auipc	a0,0x4
    3944:	ba050513          	addi	a0,a0,-1120 # 74e0 <dump_test4_asm+0x13e8>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	e1c50513          	addi	a0,a0,-484 # 7770 <dump_test4_asm+0x1678>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e3850513          	addi	a0,a0,-456 # 77a0 <dump_test4_asm+0x16a8>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c6c50513          	addi	a0,a0,-916 # 75e8 <dump_test4_asm+0x14f0>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	e1050513          	addi	a0,a0,-496 # 77a0 <dump_test4_asm+0x16a8>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	dcc50513          	addi	a0,a0,-564 # 7770 <dump_test4_asm+0x1678>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	b2850513          	addi	a0,a0,-1240 # 74e0 <dump_test4_asm+0x13e8>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	fb450513          	addi	a0,a0,-76 # 7980 <dump_test4_asm+0x1888>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	c0850513          	addi	a0,a0,-1016 # 75e8 <dump_test4_asm+0x14f0>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	aec50513          	addi	a0,a0,-1300 # 74e0 <dump_test4_asm+0x13e8>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	ab850513          	addi	a0,a0,-1352 # 74c0 <dump_test4_asm+0x13c8>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	fd450513          	addi	a0,a0,-44 # 79f0 <dump_test4_asm+0x18f8>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a9050513          	addi	a0,a0,-1392 # 74c0 <dump_test4_asm+0x13c8>
    ...
    3a56:	a7650513          	addi	a0,a0,-1418 # 74c8 <dump_test4_asm+0x13d0>
    ...
    3a72:	a7a50513          	addi	a0,a0,-1414 # 74e8 <dump_test4_asm+0x13f0>
    ...
    3a8e:	a7e50513          	addi	a0,a0,-1410 # 7508 <dump_test4_asm+0x1410>
    ...
    3aaa:	a9a50513          	addi	a0,a0,-1382 # 7540 <dump_test4_asm+0x1448>
    ...
    3ac6:	aae50513          	addi	a0,a0,-1362 # 7570 <dump_test4_asm+0x1478>
    ...
    3ae2:	aca50513          	addi	a0,a0,-1334 # 75a8 <dump_test4_asm+0x14b0>
    ...
    3afe:	ace50513          	addi	a0,a0,-1330 # 75c8 <dump_test4_asm+0x14d0>
    ...
    3b1a:	ae250513          	addi	a0,a0,-1310 # 75f8 <dump_test4_asm+0x1500>
    ...
    3b36:	aee50513          	addi	a0,a0,-1298 # 7620 <dump_test4_asm+0x1528>
    ...
    3b52:	af250513          	addi	a0,a0,-1294 # 7640 <dump_test4_asm+0x1548>
    ...
    3b6e:	afe50513          	addi	a0,a0,-1282 # 7668 <dump_test4_asm+0x1570>
    ...
    3b8a:	b0a50513          	addi	a0,a0,-1270 # 7690 <dump_test4_asm+0x1598>
    ...
    3ba6:	b1e50513          	addi	a0,a0,-1250 # 76c0 <dump_test4_asm+0x15c8>
    ...
    3bc2:	b2a50513          	addi	a0,a0,-1238 # 76e8 <dump_test4_asm+0x15f0>
    ...
    3bde:	b2650513          	addi	a0,a0,-1242 # 7700 <dump_test4_asm+0x1608>
    ...
    3bfa:	b2a50513          	addi	a0,a0,-1238 # 7720 <dump_test4_asm+0x1628>
    ...
    3c16:	b2e50513          	addi	a0,a0,-1234 # 7740 <dump_test4_asm+0x1648>
    ...
    3c32:	b5250513          	addi	a0,a0,-1198 # 7780 <dump_test4_asm+0x1688>
    ...
    3c4e:	b6650513          	addi	a0,a0,-1178 # 77b0 <dump_test4_asm+0x16b8>
    ...
    3c6a:	b6a50513          	addi	a0,a0,-1174 # 77d0 <dump_test4_asm+0x16d8>
    ...
    3c86:	b6e50513          	addi	a0,a0,-1170 # 77f0 <dump_test4_asm+0x16f8>
    ...
    3ca2:	b7250513          	addi	a0,a0,-1166 # 7810 <dump_test4_asm+0x1718>
    ...
    3cbe:	b8650513          	addi	a0,a0,-1146 # 7840 <dump_test4_asm+0x1748>
    ...
    3cda:	b9250513          	addi	a0,a0,-1134 # 7868 <dump_test4_asm+0x1770>
    ...
    3cf6:	b9e50513          	addi	a0,a0,-1122 # 7890 <dump_test4_asm+0x1798>
    ...
    3d12:	baa50513          	addi	a0,a0,-1110 # 78b8 <dump_test4_asm+0x17c0>
    ...
    3d2e:	bae50513          	addi	a0,a0,-1106 # 78d8 <dump_test4_asm+0x17e0>
    ...
    3d4a:	bb250513          	addi	a0,a0,-1102 # 78f8 <dump_test4_asm+0x1800>
    ...
    3d66:	bbe50513          	addi	a0,a0,-1090 # 7920 <dump_test4_asm+0x1828>
    ...
    3d82:	bc250513          	addi	a0,a0,-1086 # 7940 <dump_test4_asm+0x1848>
    ...
    3d9e:	bc650513          	addi	a0,a0,-1082 # 7960 <dump_test4_asm+0x1868>
    ...
    3dba:	bd250513          	addi	a0,a0,-1070 # 7988 <dump_test4_asm+0x1890>
    ...
    3dd6:	84e50513          	addi	a0,a0,-1970 # 7620 <dump_test4_asm+0x1528>
    ...
    3df2:	bba50513          	addi	a0,a0,-1094 # 79a8 <dump_test4_asm+0x18b0>
    ...
    3e0e:	bbe50513          	addi	a0,a0,-1090 # 79c8 <dump_test4_asm+0x18d0>
    ...
    3e2a:	bd250513          	addi	a0,a0,-1070 # 79f8 <dump_test4_asm+0x1900>
    ...
    3e46:	bd650513          	addi	a0,a0,-1066 # 7a18 <dump_test4_asm+0x1920>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	bc850513          	addi	a0,a0,-1080 # 7a30 <dump_test4_asm+0x1938>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	bb650513          	addi	a0,a0,-1098 # 7a30 <dump_test4_asm+0x1938>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	9d450513          	addi	a0,a0,-1580 # 6860 <dump_test4_asm+0x768>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	5ea50513          	addi	a0,a0,1514 # 7488 <dump_test4_asm+0x1390>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	58050513          	addi	a0,a0,1408 # 7430 <dump_test4_asm+0x1338>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	bd650513          	addi	a0,a0,-1066 # 7a98 <dump_test4_asm+0x19a0>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	bec50513          	addi	a0,a0,-1044 # 7ac0 <dump_test4_asm+0x19c8>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b4a50513          	addi	a0,a0,-1206 # 7a30 <dump_test4_asm+0x1938>
    ...
    3f08:	b3450513          	addi	a0,a0,-1228 # 7a38 <dump_test4_asm+0x1940>
    ...
    3f24:	b3050513          	addi	a0,a0,-1232 # 7a50 <dump_test4_asm+0x1958>
    ...
    3f40:	b2c50513          	addi	a0,a0,-1236 # 7a68 <dump_test4_asm+0x1970>
    ...
    3f5c:	b2850513          	addi	a0,a0,-1240 # 7a80 <dump_test4_asm+0x1988>
    ...
    3f78:	4c450513          	addi	a0,a0,1220 # 7438 <dump_test4_asm+0x1340>
    ...
    3f94:	b1050513          	addi	a0,a0,-1264 # 7aa0 <dump_test4_asm+0x19a8>
    ...
    3fb0:	b1c50513          	addi	a0,a0,-1252 # 7ac8 <dump_test4_asm+0x19d0>
    ...
    3fcc:	b2050513          	addi	a0,a0,-1248 # 7ae8 <dump_test4_asm+0x19f0>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	b1450513          	addi	a0,a0,-1260 # 7b08 <dump_test4_asm+0x1a10>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	af850513          	addi	a0,a0,-1288 # 7b08 <dump_test4_asm+0x1a10>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	b2c50513          	addi	a0,a0,-1236 # 7b50 <dump_test4_asm+0x1a58>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	b1450513          	addi	a0,a0,-1260 # 7b50 <dump_test4_asm+0x1a58>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	b0050513          	addi	a0,a0,-1280 # 7b50 <dump_test4_asm+0x1a58>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	aec50513          	addi	a0,a0,-1300 # 7b50 <dump_test4_asm+0x1a58>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	ad858593          	addi	a1,a1,-1320 # 7b50 <dump_test4_asm+0x1a58>
    4080:	00002517          	auipc	a0,0x2
    4084:	2d050513          	addi	a0,a0,720 # 6350 <dump_test4_asm+0x258>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a7450513          	addi	a0,a0,-1420 # 7b08 <dump_test4_asm+0x1a10>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	7b650513          	addi	a0,a0,1974 # 6860 <dump_test4_asm+0x768>
  ...
  fd = open(".", 0);
    ...
    40c4:	7a050513          	addi	a0,a0,1952 # 6860 <dump_test4_asm+0x768>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	11458593          	addi	a1,a1,276 # 61e8 <dump_test4_asm+0xf0>
  ...
  close(fd);
    ...
    4104:	a1050513          	addi	a0,a0,-1520 # 7b10 <dump_test4_asm+0x1a18>
    ...
    4120:	a1450513          	addi	a0,a0,-1516 # 7b30 <dump_test4_asm+0x1a38>
    ...
    413c:	a2850513          	addi	a0,a0,-1496 # 7b60 <dump_test4_asm+0x1a68>
    ...
    4158:	a0c50513          	addi	a0,a0,-1524 # 7b60 <dump_test4_asm+0x1a68>
    ...
    4174:	a1850513          	addi	a0,a0,-1512 # 7b88 <dump_test4_asm+0x1a90>
    ...
    4190:	a2450513          	addi	a0,a0,-1500 # 7bb0 <dump_test4_asm+0x1ab8>
    ...
    41ac:	a3050513          	addi	a0,a0,-1488 # 7bd8 <dump_test4_asm+0x1ae0>
    ...
    41c8:	a3c50513          	addi	a0,a0,-1476 # 7c00 <dump_test4_asm+0x1b08>
    ...
    41e4:	a4050513          	addi	a0,a0,-1472 # 7c20 <dump_test4_asm+0x1b28>
    ...
    4200:	a4c50513          	addi	a0,a0,-1460 # 7c48 <dump_test4_asm+0x1b50>
...
0000000000004216 <iref>:
{
    ...
    4234:	a30a0a13          	addi	s4,s4,-1488 # 7c60 <dump_test4_asm+0x1b68>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	53048493          	addi	s1,s1,1328 # 7768 <dump_test4_asm+0x1670>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	110a8a93          	addi	s5,s5,272 # 6350 <dump_test4_asm+0x258>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	91098993          	addi	s3,s3,-1776 # 7b58 <dump_test4_asm+0x1a60>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	a1450513          	addi	a0,a0,-1516 # 7c68 <dump_test4_asm+0x1b70>
    ...
    4274:	a1050513          	addi	a0,a0,-1520 # 7c80 <dump_test4_asm+0x1b88>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	18498993          	addi	s3,s3,388 # 7488 <dump_test4_asm+0x1390>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	95490913          	addi	s2,s2,-1708 # 7c60 <dump_test4_asm+0x1b68>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	10450513          	addi	a0,a0,260 # 7430 <dump_test4_asm+0x1338>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	93c50513          	addi	a0,a0,-1732 # 7c98 <dump_test4_asm+0x1ba0>
  ...
  if(pid == 0){
    ...
    4384:	91850513          	addi	a0,a0,-1768 # 7c98 <dump_test4_asm+0x1ba0>
    ...
    439a:	92250513          	addi	a0,a0,-1758 # 7cb8 <dump_test4_asm+0x1bc0>
    ...
    43b6:	8ee50513          	addi	a0,a0,-1810 # 7ca0 <dump_test4_asm+0x1ba8>
    ...
    43d2:	63250513          	addi	a0,a0,1586 # 6a00 <dump_test4_asm+0x908>
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	89c50513          	addi	a0,a0,-1892 # 7c98 <dump_test4_asm+0x1ba0>
    ...
    4414:	7e050513          	addi	a0,a0,2016 # 6bf0 <dump_test4_asm+0xaf8>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	89250513          	addi	a0,a0,-1902 # 7ce0 <dump_test4_asm+0x1be8>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	86650513          	addi	a0,a0,-1946 # 7ce0 <dump_test4_asm+0x1be8>
  ...
  sleep(10); // one second
    ...
    44b6:	70e50513          	addi	a0,a0,1806 # 6bc0 <dump_test4_asm+0xac8>
    ...
    44d0:	81448493          	addi	s1,s1,-2028 # 7ce0 <dump_test4_asm+0x1be8>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
    ...
    44f8:	7ec50513          	addi	a0,a0,2028 # 7ce0 <dump_test4_asm+0x1be8>
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	48650513          	addi	a0,a0,1158 # 6a00 <dump_test4_asm+0x908>
    ...
    45a4:	75050513          	addi	a0,a0,1872 # 7cf0 <dump_test4_asm+0x1bf8>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	5e050513          	addi	a0,a0,1504 # 6bc0 <dump_test4_asm+0xac8>
  ...
  if(pid2 == 0)
    ...
    4612:	3f250513          	addi	a0,a0,1010 # 6a00 <dump_test4_asm+0x908>
  ...
  if(pid3 == 0){
    ...
    4656:	b9658593          	addi	a1,a1,-1130 # 61e8 <dump_test4_asm+0xf0>
    ...
    4680:	38450513          	addi	a0,a0,900 # 6a00 <dump_test4_asm+0x908>
    ...
    469c:	67850513          	addi	a0,a0,1656 # 7d10 <dump_test4_asm+0x1c18>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	65450513          	addi	a0,a0,1620 # 7d28 <dump_test4_asm+0x1c30>
  ...
  printf("kill... ");
    ...
    4704:	64050513          	addi	a0,a0,1600 # 7d40 <dump_test4_asm+0x1c48>
  ...
  printf("wait... ");
    ...
    4732:	62250513          	addi	a0,a0,1570 # 7d50 <dump_test4_asm+0x1c58>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	25250513          	addi	a0,a0,594 # 6a00 <dump_test4_asm+0x908>
    ...
    47ce:	3be50513          	addi	a0,a0,958 # 6b88 <dump_test4_asm+0xa90>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	2c850513          	addi	a0,a0,712 # 6b08 <dump_test4_asm+0xa10>
    ...
    4878:	97458593          	addi	a1,a1,-1676 # 61e8 <dump_test4_asm+0xf0>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	42850513          	addi	a0,a0,1064 # 7d60 <dump_test4_asm+0x1c68>
    ...
    4958:	0ac50513          	addi	a0,a0,172 # 6a00 <dump_test4_asm+0x908>
    ...
    49a4:	3e050513          	addi	a0,a0,992 # 7d80 <dump_test4_asm+0x1c88>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	36c50513          	addi	a0,a0,876 # 7db0 <dump_test4_asm+0x1cb8>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	2e650513          	addi	a0,a0,742 # 7de0 <dump_test4_asm+0x1ce8>
    ...
    4b1a:	2f250513          	addi	a0,a0,754 # 7e08 <dump_test4_asm+0x1d10>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	27650513          	addi	a0,a0,630 # 7dd0 <dump_test4_asm+0x1cd8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	28e50513          	addi	a0,a0,654 # 7e28 <dump_test4_asm+0x1d30>
  ...
  unlink("sharedfd");
    ...
    4bda:	1fa50513          	addi	a0,a0,506 # 7dd0 <dump_test4_asm+0x1cd8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	25450513          	addi	a0,a0,596 # 7e50 <dump_test4_asm+0x1d58>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	22878793          	addi	a5,a5,552 # 7e68 <dump_test4_asm+0x1d70>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	22478793          	addi	a5,a5,548 # 7e70 <dump_test4_asm+0x1d78>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	22078793          	addi	a5,a5,544 # 7e78 <dump_test4_asm+0x1d80>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	21c78793          	addi	a5,a5,540 # 7e80 <dump_test4_asm+0x1d88>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cd6:	13650513          	addi	a0,a0,310 # 6e08 <dump_test4_asm+0xd10>
    ...
    4d50:	13c50513          	addi	a0,a0,316 # 7e88 <dump_test4_asm+0x1d90>
    ...
    4d6a:	13250513          	addi	a0,a0,306 # 7e98 <dump_test4_asm+0x1da0>
    ...
    4d90:	12450513          	addi	a0,a0,292 # 7eb0 <dump_test4_asm+0x1db8>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	0ac50513          	addi	a0,a0,172 # 7ec0 <dump_test4_asm+0x1dc8>
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e7a:	062b8b93          	addi	s7,s7,98 # 7ed8 <dump_test4_asm+0x1de0>
  for(i = 0; i < N; i++){
    ...
    4ebc:	02850513          	addi	a0,a0,40 # 7ee0 <dump_test4_asm+0x1de8>
    ...
    4eda:	00250513          	addi	a0,a0,2 # 7ed8 <dump_test4_asm+0x1de0>
  ...
  fd = open(".", 0);
    ...
    4f12:	95250513          	addi	a0,a0,-1710 # 6860 <dump_test4_asm+0x768>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f8a:	f7a50513          	addi	a0,a0,-134 # 7f00 <dump_test4_asm+0x1e08>
    ...
    4faa:	f7a50513          	addi	a0,a0,-134 # 7f20 <dump_test4_asm+0x1e28>
  ...
  for(i = 0; i < N; i++){
    ...
    4fe2:	f6a50513          	addi	a0,a0,-150 # 7f48 <dump_test4_asm+0x1e50>
    ...
    4ffe:	a0650513          	addi	a0,a0,-1530 # 6a00 <dump_test4_asm+0x908>
...
00000000000051a8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5230:	d5450513          	addi	a0,a0,-684 # 7f80 <dump_test4_asm+0x1e88>
  ...
  for(i = 0; ; i++){
    ...
    5294:	d0050513          	addi	a0,a0,-768 # 7f90 <dump_test4_asm+0x1e98>
    ...
    52b0:	d0450513          	addi	a0,a0,-764 # 7fb0 <dump_test4_asm+0x1eb8>
    ...
    52cc:	d0850513          	addi	a0,a0,-760 # 7fd0 <dump_test4_asm+0x1ed8>
    ...
    52e8:	d0c50513          	addi	a0,a0,-756 # 7ff0 <dump_test4_asm+0x1ef8>
    ...
    5304:	d1050513          	addi	a0,a0,-752 # 8010 <dump_test4_asm+0x1f18>
    ...
    5320:	d0c50513          	addi	a0,a0,-756 # 8028 <dump_test4_asm+0x1f30>
  ...
  unlink("bigfile.dat");
    ...
    534e:	c3650513          	addi	a0,a0,-970 # 7f80 <dump_test4_asm+0x1e88>
    ...
    5372:	cda50513          	addi	a0,a0,-806 # 8048 <dump_test4_asm+0x1f50>
...
0000000000005388 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53a8:	cc450513          	addi	a0,a0,-828 # 8068 <dump_test4_asm+0x1f70>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53c8:	cb4c8c93          	addi	s9,s9,-844 # 8078 <dump_test4_asm+0x1f80>
    name[0] = 'f';
    ...
    5438:	c5450513          	addi	a0,a0,-940 # 8088 <dump_test4_asm+0x1f90>
  ...
  printf("fsfull test finished\n");
    ...
    54ae:	bfe50513          	addi	a0,a0,-1026 # 80a8 <dump_test4_asm+0x1fb0>
    ...
    5504:	b9850513          	addi	a0,a0,-1128 # 8098 <dump_test4_asm+0x1fa0>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5536:	b8e50513          	addi	a0,a0,-1138 # 80c0 <dump_test4_asm+0x1fc8>
  ...
  if(pid == 0) {
    ...
    5566:	b8650513          	addi	a0,a0,-1146 # 80e8 <dump_test4_asm+0x1ff0>
    ...
    558a:	b4a50513          	addi	a0,a0,-1206 # 80d0 <dump_test4_asm+0x1fd8>
    ...
    55b2:	b4250513          	addi	a0,a0,-1214 # 80f0 <dump_test4_asm+0x1ff8>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5602:	afa50513          	addi	a0,a0,-1286 # 80f8 <dump_test4_asm+0x2000>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    565c:	b9098993          	addi	s3,s3,-1136 # 61e8 <dump_test4_asm+0xf0>
      uint64 a = (uint64) sbrk(4096);
    ...
    568e:	ac650513          	addi	a0,a0,-1338 # 8150 <dump_test4_asm+0x2058>
    ...
    56a8:	a6c50513          	addi	a0,a0,-1428 # 8110 <dump_test4_asm+0x2018>
    ...
    56c2:	a7250513          	addi	a0,a0,-1422 # 8130 <dump_test4_asm+0x2038>
  ...
  while(1){
    ...
    5710:	a6450513          	addi	a0,a0,-1436 # 8170 <dump_test4_asm+0x2078>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5772:	a22b8b93          	addi	s7,s7,-1502 # 8190 <dump_test4_asm+0x2098>
    int free0 = countfree();
    int free1 = 0;
    ...
    578c:	a20d0d13          	addi	s10,s10,-1504 # 81a8 <dump_test4_asm+0x20b0>
          return 1;
        }
      }
    }
    ...
    5794:	a38c8c93          	addi	s9,s9,-1480 # 81c8 <dump_test4_asm+0x20d0>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    586c:	99058593          	addi	a1,a1,-1648 # 81f8 <dump_test4_asm+0x2100>
  ...
  char *justone = 0;
    ...
    588a:	97a58593          	addi	a1,a1,-1670 # 8200 <dump_test4_asm+0x2108>
    ...
    58a0:	9b458593          	addi	a1,a1,-1612 # 8250 <dump_test4_asm+0x2158>
  ...
  int continuous = 0;
    ...
    58cc:	94050513          	addi	a0,a0,-1728 # 8208 <dump_test4_asm+0x2110>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58f2:	94a50513          	addi	a0,a0,-1718 # 8238 <dump_test4_asm+0x2140>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5c7e:	99e50513          	addi	a0,a0,-1634 # 8618 <digits>
    5c82:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5d82:	84270713          	addi	a4,a4,-1982 # 85c0 <dump_test4_asm+0x24c8>
  ...
  putc(fd, 'x');
    ...
    5e0c:	810b8b93          	addi	s7,s7,-2032 # 8618 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5e60:	75c90913          	addi	s2,s2,1884 # 85b8 <dump_test4_asm+0x24c0>
        while(*s != 0){
...
000000000000609c <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000060b8 <dump_test3_asm>:
...
dump_test3_asm:
  ...
  li s3, -12
    60ba:	59d1                	li	s3,-12
  li s4, 123
    60bc:	07b00a13          	li	s4,123
  li s5, -1234
    60c0:	b2e00a93          	li	s5,-1234
  li s6, 12345
    60c4:	6b0d                	lui	s6,0x3
    60c6:	039b0b1b          	addiw	s6,s6,57 # 3039 <fourteen+0x1b>
  li s7, -123456
    60ca:	7b89                	lui	s7,0xfffe2
    60cc:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffd2148>
  li s8, 1234567
    60d0:	0012dc37          	lui	s8,0x12d
    60d4:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x11da0f>
  li s9, -12345678
    60d8:	ff43acb7          	lui	s9,0xff43a
    60dc:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff42a23a>
  li s10, 123456789
    60e0:	075bdd37          	lui	s10,0x75bd
    60e4:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75ad09d>
  li s11, -1234567890
    60e8:	b66a0db7          	lui	s11,0xb66a0
    60ec:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb66900b6>
#ifdef SYS_dump
  li a7, SYS_dump
    60f0:	48d9                	li	a7,22
  ecall
...
00000000000060f8 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
    60f8:	80000937          	lui	s2,0x80000
    60fc:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fff0387>
  li s3, -2147483648
    60fe:	800009b7          	lui	s3,0x80000
  li s4, 1337
    6102:	53900a13          	li	s4,1337
  li s5, 2020
    6106:	7e400a93          	li	s5,2020
  li s6, 3234
    610a:	6b05                	lui	s6,0x1
    610c:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <writebig+0x11a>
  li s7, 3235
    6110:	6b85                	lui	s7,0x1
    6112:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <writebig+0x11b>
  li s8, 3236
    6116:	6c05                	lui	s8,0x1
    6118:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <writebig+0x11c>
  li s9, 3237
    611c:	6c85                	lui	s9,0x1
    611e:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <writebig+0x11d>
  li s10, 3238
    6122:	6d05                	lui	s10,0x1
    6124:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <writebig+0x11e>
  li s11, 3239
    6128:	6d85                	lui	s11,0x1
    612a:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <writebig+0x11f>
#ifdef SYS_dump
  li a7, SYS_dump
    612e:	48d9                	li	a7,22
  ecall
